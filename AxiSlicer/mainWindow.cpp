...
void mainWindow::updateSliceMode()
{
...
void mainWindow::onOneAtATimeSwitch(int e)
...
void mainWindow::OnPreferences(int e)
{
...
void mainWindow::OnMachineSettings(int e)
{
...
void mainWindow::OnDropFiles(char* files)
{
/*		if len(files) > 0:
...
void mainWindow::OnModelMRU(int e)
{
...
void mainWindow::addToModelMRU(char* file)
{
...
void mainWindow::OnProfileMRU(int e)
{/*
...
void mainWindow::addToProfileMRU(char* file)
{
...
void mainWindow::updateProfileToAllControls()
{/*
		self.scene.updateProfileToControls()
...
void mainWindow::reloadSettingPanels()
{/*
...
void mainWindow::updateMachineMenu()
{/*
...
void mainWindow::OnLoadProfile(int e)
{/*
...
void mainWindow::OnLoadProfileFromGcode(int e)
{/*
...
void mainWindow::OnSaveProfile(int e)
{/*
...
void mainWindow::OnResetProfile(int e)
{/*
...
void mainWindow::OnSimpleSwitch(int e)
{/*
		profile.putPreference('startMode', 'Simple')
		self.updateSliceMode()
		*/}

void mainWindow::OnNormalSwitch(int e)
{/*
		profile.putPreference('startMode', 'Normal')
		self.updateSliceMode()
		*/}

void mainWindow::OnDefaultMarlinFirmware(int e)
{/*
		firmwareInstall.InstallFirmware()
		*/}

void mainWindow::OnCustomFirmware(int e)
{/*
...
void mainWindow::OnFirstRunWizard(int e)
{/*
		self.Hide()
...
void mainWindow::OnSelectMachine(int index)
{/*
		profile.setActiveMachine(index)
		self.reloadSettingPanels()
		*/}

void mainWindow::OnBedLevelWizard(int e)
{/*
		configWizard.bedLevelWizard()
*/}

void mainWindow::OnHeadOffsetWizard(int e)
{/*
		configWizard.headOffsetWizard()
		*/}

void mainWindow::OnExpertOpen(int e)
{/*
...
void mainWindow::OnMinecraftImport(int e)
{/*
...
void mainWindow::OnPIDDebugger(int e)
{/*
...
void mainWindow::onCopyProfileClipboard(int e)
{/*
		try:
			if not wx.TheClipboard.IsOpened():
...
void mainWindow::OnCheckForUpdate(int e)
{/*
...
void mainWindow::OnQuit(int e){/*
							   self.Close()*/}

/*
normalSettingsPanel::normalSettingsPanel(self, parent, callback = None)
{
