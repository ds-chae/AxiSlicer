...
// OpenGLTestDoc.cpp : COpenGLTestDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void COpenGLTestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void COpenGLTestDoc::InitializeSearchContent()
{
...
void COpenGLTestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
