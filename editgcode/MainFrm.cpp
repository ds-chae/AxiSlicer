...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_BAECHI_WIZARD, &CMainFrame::OnBaechiWizard)
	ON_COMMAND(ID_ADD_GCODE, &CMainFrame::OnAddGcode)
END_MESSAGE_MAP()
...
void CMainFrame::OnBaechiWizard()
{
	if(pBaechiWizard == NULL) {
		pBaechiWizard = new CBaechiWizard(this);
		pBaechiWizard->Create(CBaechiWizard::IDD);
	}
	pBaechiWizard->ShowWindow(SW_SHOW);
}


void CMainFrame::OnAddGcode()
{
}
